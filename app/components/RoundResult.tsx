...
import { Fingerprint, Route, Trophy, Zap, Copy, Check } from "lucide-react";
      ...
      <div className="rounded-xl bg-white/[0.02] border border-white/[0.05] p-4">
        ...
        <div className="flex flex-wrap gap-1 mb-2">
          {path.map((step, i) => (
            <span
              key={i}
              className={`inline-flex items-center justify-center h-6 w-6 rounded-lg text-[10px] font-bold font-mono ${step === "L"
